...
const StrengthGraphBar: FC<StrengthGraphEntry> = ({ date, strength }) => {
  ...
  return (
    <div className="flex flex-col gap-2 items-center">
      <div className="w-6 h-full flex items-end bg-day-400 dark:bg-night-200 rounded-2xl">
        <div
          className="w-full bg-gradient-to-t from-dream-700 to-dream-500
          flex items-start pt-1 justify-center rounded-2xl text-xs text-dream-100
